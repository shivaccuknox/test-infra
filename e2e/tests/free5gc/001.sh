...
regional_pkg_rev=$(kpt alpha rpkg clone -n default "https://github.com/shivaccuknox/catalog.git/infra/capi/nephio-workload-cluster@$REVISION" --repository mgmt regional | cut -f 1 -d ' ')
